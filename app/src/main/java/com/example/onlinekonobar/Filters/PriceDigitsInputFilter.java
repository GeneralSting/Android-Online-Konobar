package com.example.onlinekonobar.Filters;

import android.text.InputFilter;
import android.text.Spanned;

public class PriceDigitsInputFilter implements InputFilter {
    ...
    public PriceDigitsInputFilter(int maxDigitsBeforeDot, int maxDigitsAfterDot, double maxValue) {
